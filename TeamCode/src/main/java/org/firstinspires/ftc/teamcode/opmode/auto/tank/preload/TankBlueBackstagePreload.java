...
public class TankBlueBackstagePreload extends MatchOpMode {
...
//            new ConditionalCommand(new TurnCommand(drivetrain, 20), new InstantCommand(),
//                    TeamMarkerPipeline.FFPosition.RIGHT==vision.getFinalPosition()),
